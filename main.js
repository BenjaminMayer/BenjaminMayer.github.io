...
var FeedComponent = /** @class */ (function () {
    ...
    FeedComponent.prototype.ngOnInit = function () {
        ...
        this.addMsg = 0;
        this.feed = this.db.list('/messages', function (ref) { return ref.orderByKey().limitToLast(20 + _this.addMsg); }).valueChanges(); /// <reference path="" />
        console.log(this.feed);
    };
    FeedComponent.prototype.ngOnChanges = function () {
        var _this = this;
        this.feed = this.db.list('/messages', function (ref) { return ref.orderByKey().limitToLast(20 + _this.addMsg); }).valueChanges();
    };
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signUp = function (email, password, displayName) {
        ...
        return this.afAuth.auth.createUserWithEmailAndPassword(email, password)
            ...
            var status = 'online';
            _this.setUserData(email, displayName, status, "users/" + _this.currentUserId);
    ...
    AuthService.prototype.setUserStatus = function (status) {
        var path = "users/" + this.afAuth.auth.currentUser.uid;
        var data = {
            status: status
        };
        this.db.object(path).update(data)
    ...
    AuthService.prototype.getPresence = function (uid) {
        return this.db.object("users/" + uid).valueChanges();
    };
    AuthService.prototype.updateOnDisconnect = function () {
        var _this = this;
        return this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function (user) {
            if (user) {
                _this.db.object("users/" + user.uid).query.ref.onDisconnect()
    ...
    /* updateonIdle(){
       this.mouseEvent = fromEvent(document,'mousemove').t
     }*/
    AuthService.prototype.updateOnUser = function () {
        var _this = this;
        var connection = this.db.object('.info/connected').valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (connected) { return connected ? 'online' : 'offline'; }));
        return this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(function (user) { return user ? connection : Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])('offline'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function (status) { return _this.setUserStatus(status); }));
    };
    AuthService.prototype.upDateOnAway = function () {
        var _this = this;
        document.onvisibilitychange = function (e) {
            if (document.visibilityState == 'hidden') {
                _this.setUserStatus('away');
            }
            else {
...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.getMessages = function () {
        ...
        return this.db.list('/messages', function (ref) { return ref.orderByKey().limitToLast(15); });
    };
